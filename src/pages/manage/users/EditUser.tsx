...
function EditUser() {
  ...
  let portalUser = PortalUserService.getInstance().getUserById(parseInt(params["portalUserId"]!));
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ fontSize: "32px", marginBottom: "15px", alignSelf: "center" }}>Modify User</p>
        <Form
